...
#define	_REENTRANT	1	/* Must be defined before including math.h for Mac OS X.  Most of the Mathomatic code is not reentrant. */
...
#if	HANDHELD
#undef	UNIX		/* Don't include the extra Unix desktop features when running on a handheld device. */
#endif
...
#if	SECURE && SHELL_OUT
#warning SHELL_OUT defined during secure mode compilation.  This is a security issue.
#endif
