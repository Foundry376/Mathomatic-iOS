...
#define	MAX_CMD_LEN	min((max(PATH_MAX, 1024)), 16384)	/* maximum command line length (not expression input), also max filename length */
...
/* The correct way to determine if equation number "en" is not in use. */
