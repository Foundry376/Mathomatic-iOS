 ...
 *
 * If *vp is 0, automatically select the best base variable and return it in *vp.
 */
int
...
/*
 * Do the actual polynomial division using a simple generalized polynomial long division algorithm.
 */
static int
...
/*
 * This routine automatically finds the best normal variable to do polynomial division with.
 *
 * Returns 0 if nothing was found, otherwise the selected base variable is returned in *vp1.
 */
static int
