...
"math" is a shell script and is only known to work with GNU software.  It can
be installed for system-wide use with "make m4install".
...
Readline doesn't work while using m4 (complain to the creators of GNU m4),
and the "quit" and "exit" commands have some delay.  You can use the EOF
