...
/* This file was created with "cproto -DUNIX -DREADLINE *.c >cproto.h" */
/* Copy this file to proto.h to compile Mathomatic with -Wall, if you wish. */
/* am.c */
...
void check_divide_by_zero(double denominator);
/* cmds.c */
...
int push_en(int en);
int display_current_directory(void);
...
void make_fractions(token_type *equation, int *np);
/* globals.c */
/* help.c */
...
char *parse_section(token_type *equation, int *np, char *cp);
...
void simpb_side(token_type *equation, int *np, int power_flag, int fc_level);
