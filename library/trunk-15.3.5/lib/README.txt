...
edit, "factor number", plot, push, quit, and tally. To make up for the lack
of the calculate command, the replace, approximate, and "simplify sign"
commands are provided, allowing very similar functionality.
...
Please define the C preprocessor name HANDHELD when compiling this library
